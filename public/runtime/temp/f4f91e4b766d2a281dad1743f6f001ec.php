<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"E:\xampp\htdocs\newxy\public/../application/admin\view\money\show_send_list.html";i:1468919142;}*/ ?>
...
if(confirm('是否付款')){
  ...
  o.money_send_id=money_send_id;
   ...
   // console.log(data.result_code[0]);
