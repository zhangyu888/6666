<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\xampp\htdocs\xiangyuan\public/../application/index\view\user\login.html";i:1471317481;s:77:"D:\xampp\htdocs\xiangyuan\public/../application/index\view\Public\header.html";i:1471854413;s:77:"D:\xampp\htdocs\xiangyuan\public/../application/index\view\Public\footer.html";i:1470291091;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
.login{background:#f3f0eb;margin:10px 0px;text-align:center;border:1px solid #934948;height:800px;position:relative;}

table{border:1px solid #b77a75;margin:0 auto;background:#f8f4d9;height:500px;width:400px;font-weight:bold;margin-top:150px;box-shadow:2px 2px 2px #a19a88;}
label{font-size:30px;font-weight:bold;}

input{box-shadow:2px 2px 2px #a19a88;}
.uname,.pwd{background:#f8f4d9;height:35px;width:200px;border:1px solid #cba08d;}
...
<div id="main">
	<div class="login">
    	<form method="post" action="">
        	<table>
            	<tr>
                	<td class=""><label for="">用户账号：</label></td>
                    <td><input class="uname" name="username" type="text" value="<?php echo \think\Cookie::get('username'); ?>"></td>
            	</tr>               	
            	<tr>
                	<td class=""><label for="">用户密码：</label></td>
                    <td><input class="pwd" name="password" type="password" value="<?php echo \think\Cookie::get('password'); ?>"></td>
            	</tr>
            	<tr >
                	<td colspan="2"> <input id="remember" name="remember" type="checkbox" value="1"><label for="remember" style="font-size:14px !important">&nbsp;记住密码</label></td>
                    
            	</tr>
            	<tr>
                	<td colspan="2"> <input class="btn" name="submit" type="submit" value="登 录"> <a href="/index/user/forget">&nbsp;忘记密码</a></td>
