<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\xampp\htdocs\xiangyuan\public/../application/admin\view\img\edit.html";i:1470363552;}*/ ?>
<!doctype html>
<html lang="zh-CN">
<head>
  <meta charset="UTF-8">
...
<div class="content" style="float:center;">
          ...
          <form method="post"   action="/admin/Img/upsave"  enctype="multipart/form-data" >
 ...
 <TR>
                  ...
                  <TD>（尺寸：宽720像素，高400像素） 小于500k;<div><input name="upfile" type="file"  class="text textMiddle inputQ" value="请选择图片" /><img width="40px" height="40px" src="<?php echo $info['pic']; ?>"></div></TR>
				...
				<input type="hidden" name="id" value="<?php echo $info['id']; ?>" />
                 ...
                 <TR>
                  ...
                  <TD><input type="text" class="px" id="url" value="<?php echo $info['url']; ?>" name="url" style="width:280px;"></TD>
