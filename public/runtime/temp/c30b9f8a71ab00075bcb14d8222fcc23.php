<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\xampp\htdocs\newxy\public/../application/admin\view\article\showlist.html";i:1468833367;}*/ ?>
...
<script type="text/javascript" src="<?php echo ADMIN_JS_URL; ?>jquery-1.9.1.min.js"></script>
  ...
  <?php foreach($article_list as $v): ?>
              ...
              <td>手机端：<?php echo $domain; ?>/wap/content/id/<?php echo $v['article_id']; ?><br>电脑端：<?php echo $domain; ?>/index/content/id/<?php echo $v['article_id']; ?></td>
...
<td><?php echo date("Y-m-d H:i",$v['create_time']); ?></td>
                    <td><a href="javascript:;" onclick="delete_product(<?php echo $v['article_id']; ?>)">删除</a></td>
                 </tr>
                    <?php endforeach; ?>
