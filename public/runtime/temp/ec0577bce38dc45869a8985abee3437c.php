<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\xampp\htdocs\xiangyuan\public/../application/admin\view\article\edit.html";i:1470882224;}*/ ?>
...
<div class="panel panel-info">
  <div class="panel-heading">当前位置是：文章管理->修改文章</div>
  ...
  <form action="/index.php/admin/article/add" method="post">
	...
	<div class="input-group"><span class="input-group-addon " id="basic-addon1">文章分类</span><select name="cat_id" class="form-control w200">
         <?php foreach($cat_list as $cat): ?>
     <option <?php if($cat['cat_id'] == $cat_id): ?>selected<?php endif; ?> value="<?php echo $cat['cat_id']; ?>"><?php echo $cat['cat_name']; ?></option>
