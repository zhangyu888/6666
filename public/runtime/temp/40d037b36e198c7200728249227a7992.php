<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\xampp\htdocs\xiangyuan\public/../application/admin\view\config\set.html";i:1471257425;}*/ ?>
...
<div class="panel panel-info">
 ...
 <ul class="nav nav-tabs" role="tablist" id="feature-tab">
    ...
    <div class="input-group"><span class="input-group-addon " id="basic-addon1">客服QQ</span><input name="shop_qq" type="text" class="form-control w200" placeholder="" aria-describedby="basic-addon1" value="<?php echo $config['shop_qq']; ?>"></div>
      ...
      <div class="input-group"><span class="input-group-addon " id="basic-addon1">微信</span><input name="shop_wx" type="text" class="form-control w200" placeholder="" aria-describedby="basic-addon1" value="<?php echo $config['shop_wx']; ?>"></div>
    
      <div class="input-group"><span class="input-group-addon " id="basic-addon1">传真</span><input name="shop_fax" type="text" class="form-control w200" placeholder="" aria-describedby="basic-addon1" value="<?php echo $config['shop_fax']; ?>"></div>
    
      <div class="input-group"><span class="input-group-addon " id="basic-addon1">邮编</span><input name="shop_postcode" type="text" class="form-control w200" placeholder="" aria-describedby="basic-addon1" value="<?php echo $config['shop_postcode']; ?>"></div>
    
      <div class="input-group"><span class="input-group-addon " id="basic-addon1">网址</span><input name="shop_site" type="text" class="form-control w200" placeholder="" aria-describedby="basic-addon1" value="<?php echo $config['shop_site']; ?>"></div>
