<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\xampp\htdocs\maogod\public/../application/admin\view\config\set.html";i:1473064892;}*/ ?>
...
<div class="panel panel-info">
 ...
 <ul class="nav nav-tabs" role="tablist" id="feature-tab">
    ...
    <div class="input-group"><span class="input-group-addon " id="basic-addon1">客服QQ</span><input name="shop_qq" type="text" class="form-control w200" placeholder="" aria-describedby="basic-addon1" value="<?php echo $config['shop_qq']; ?>"></div>
      ...
      <div class="input-group"><span class="input-group-addon " id="basic-addon1">邮箱</span><input name="shop_email" type="text" class="form-control w200" placeholder="" aria-describedby="basic-addon1" value="<?php echo $config['shop_email']; ?>"></div>
