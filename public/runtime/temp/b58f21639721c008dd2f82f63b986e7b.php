<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\xampp\htdocs\xiangyuan\public/../application/admin\view\goods\catelist.html";i:1468574312;}*/ ?>
...
<script type="text/javascript" src="<?php echo ADMIN_JS_URL; ?>jquery-1.9.1.min.js"></script>
    ...
    <div id="button" class="mt10">
       ...
       <a href="/admin/goods/add_cate"><input type="button" id="btn4" class="btn btn82 btn_add" value="添加"></a>
    </div>
    <div id="search_bar" class="mt10">
       <div class="box">
          ...
          <div class="box_border">
            ...
            <div class="box_top"><b class="pl15">当前位置是：商品管理->分类列表</b></div>
  ...
  <?php foreach($cate_list as $v): ?>
                   ...
                   <td><a href="/index.php/admin/goods/add_cate/cate_id/<?php echo $v['cate_id']; ?>"><?php echo $v['cate_name']; ?></a></td>
                  
                   <td><?php echo $v['cate_pid']; ?></td>

                    <td><a href="javascript:;" onclick="delete_tiem(<?php echo $v['cate_id']; ?>)">删除</a></td>
                 </tr>
                    <?php endforeach; ?>
         ...
         <script type="text/javascript">
            ...
            function delete_tiem(id){
              if(confirm('是否删除')){
               
                  
                    location.href='/admin/goods/del_cate/cate_id/'+id;
