...
<div class="header-wrap">
  <header class="public-head-layout wrapper">
    <h1 class="site-logo"><a href="/"><img src="http://www.zsly.com/images/logo.png" class="pngFix"></a></h1>
...
<div class="nc-login-layout">
  <div class="left-pic"><img src="http://www.zsly.com/images/reg.jpg" border="0"></div>
    <div class="nc-login">
    ...
    <div class="nc-login-content">
      <form id="register_form" method="post" action="user.php" onsubmit="return register();">
  

        <dl>
          <dt>注册邮箱</dt>
          <dd style="min-height:54px;">
            <input type="text" id="email" name="email"  class="text tip" value="" title="">
        ...
        <dl>
          <dt>确认密码</dt>
          <dd style="min-height:54px;">
            <input type="password" id="confirm_password" name="confirm_password" class="text tip" title="请再次输入您的密码">
            <label></label>
          </dd>
        </dl>
              <dl>
        ...
        <dl>
          ...
          <dd>
            ...
            <a href="user.php?act=login">立即登录</a>
            <label><input name="agreement" type="checkbox" class="vm ml10" id="clause" value="1" checked="checked">
       同意<a href="#" style="color:red">《用户协议》</a></label>
          </dd>
        </dl>
      ...
      <dl class="mt10 mb10">
        <dt>&nbsp;</dt>
        <dd>还不是本站会员？立即<a href="user.php?act=register" class="register" rel="nofollow">注册</a></dd>
      </dl>
          </div>
