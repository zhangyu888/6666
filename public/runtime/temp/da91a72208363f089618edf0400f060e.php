<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\xampp\htdocs\xiangyuan\public/../application/index\view\article\blzs.html";i:1471080387;s:77:"D:\xampp\htdocs\xiangyuan\public/../application/index\view\Public\header.html";i:1471254042;s:77:"D:\xampp\htdocs\xiangyuan\public/../application/index\view\Public\footer.html";i:1470291091;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<title><?php echo $blzs['article_name']; ?></title>
<style>
*{padding:0;margin:0;}
...
section{background:#fcfaee;border:1px solid #a7756a;margin:10px 0px;min-height:800px;}
section h1{color:#000;line-height:80px; text-align:center;font-size:30px;margin:30px 0px;}
section p{line-height:1em;padding:0px 100px 50px 100px;font-size:1.5em;}
...
<div id="main">
	...
	<section>
 		<h1><?php echo $blzs['article_name']; ?></h1>
      
        <p>  <?php if($blzs['article_content']): ?> 
     <?php echo $blzs['article_content']; endif; ?> </p>
    </section>
