<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\xampp\htdocs\maogod\public/../application/admin\view\article\catlist.html";i:1473059727;}*/ ?>
...
<script type="text/javascript" src="<?php echo ADMIN_JS_URL; ?>jquery-1.9.1.min.js"></script>
  ...
  <?php foreach($cat_list as $v): ?>
                   ...
                   <td><?php echo $v['cat_pid']; ?></td>
                    ...
                    <td><a href="javascript:;" onclick="delete_item(<?php echo $v['cat_id']; ?>)">删除</a></td>
                 </tr>
                    <?php endforeach; ?>
         ...
         <script type="text/javascript">
            ...
            function delete_item(id){
              if(confirm('是否删除')){
                    ...
                    location.href='/admin/article/del_cat/cat_id/'+id;
