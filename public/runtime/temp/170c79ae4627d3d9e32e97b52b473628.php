<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\xampp\htdocs\xiangyuan\public/../application/index\view\goods\love_goods_list.html";i:1471938513;}*/ ?>
<style>
*{padding:0;margin:0;}
...
.g img{width:100%;height:80%;}
					...
					<?php if(is_array($love_goods_list) || $love_goods_list instanceof \think\Collection): if( count($love_goods_list)==0 ) : echo "" ;else: foreach($love_goods_list as $key=>$goods): ?>
